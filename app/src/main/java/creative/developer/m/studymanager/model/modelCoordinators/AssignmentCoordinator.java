...
public class AssignmentCoordinator extends Observable{
    ...
    * @param context is the Context's instance for the class that calls this method.
    */
    public static AssignmentEntity getAssignmentbyID(int id, Context context) {
        DataRepository tempRepo = DataRepository.getInstance(AppDatabase.getInstance(context));
        return tempRepo.getAssignmentByID(id);
    }
